...
public class ServerControlPanel {
	...
	public static JTextField feedbackTextField;
	...
	// Update value of textfield with message from client
	public static void updateTextField(String messageFromClient){
		feedbackTextField.setText(messageFromClient);
	}
}
